<?php
    ...
    if (isset($_SESSION['user_id']) && $_SESSION['user_id']) {
        ...
        $headerContent .= '<li><a href="/~s5721355/show_profile.php"> <img src="/~s5721355/images/profile/profile.png" alt="Il tuo profilo" class="profile-logo" /> Il tuo profilo </a></li>
