...
<html lang="it">
        ...
        <body>
                ...
                <div class="filter-bar">
                        ...
                        <ul>
                                <li><a href="#" onclick="applyFilter('release_date')">Ordina per Data di Release</a></li>
                                <li><a href="#" onclick="applyFilter('alphabetical')">Ordina per ordine alfabetico</a></li>
                                <li><a href="#" onclick="applyFilter('top_rated')">Ordina dal più votato</a></li>
                                <li><a href="#" onclick="applyFilter('highest_rated')">Ordina dall'album con la media voti migliori</a></li>
                        </ul>
                        </div>
                </div>
